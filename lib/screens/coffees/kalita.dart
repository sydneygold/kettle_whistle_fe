...
class KalitaCard extends StatefulWidget {
  KalitaCard({this.coffeeDeets}); 

  @override
  _KalitaCardState createState() => _KalitaCardState();

  final coffeeDeets;
}

class _KalitaCardState extends State<KalitaCard> {
  String name;
  String image;
  String ingredients;
  String tools;
