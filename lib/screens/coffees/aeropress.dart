...
class AeroPressCard extends StatefulWidget {
  AeroPressCard({this.coffeeDeets}); 

  @override
  _AeroPressCardState createState() => _AeroPressCardState();

  final coffeeDeets;
}

class _AeroPressCardState extends State<AeroPressCard> {
  String name;
  String image;
  String ingredients;
  String tools;
                    ...
                    child: Column(
                      children: [
                        ...
                        SingleChildScrollView(
                          child: Container(
                            height: 20.0,
                            margin: EdgeInsets.only(top: 5.0, left: 14.0, right: 8.0),
                            child: Text(
