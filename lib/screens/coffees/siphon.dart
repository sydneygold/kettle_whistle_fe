...
class SiphonCard extends StatefulWidget {
  SiphonCard({this.coffeeDeets}); 

  @override
  _SiphonCardState createState() => _SiphonCardState();

  final coffeeDeets;
}

class _SiphonCardState extends State<SiphonCard> {
