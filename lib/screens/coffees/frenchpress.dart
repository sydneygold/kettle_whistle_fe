...
class FrenchPressCard extends StatefulWidget {
  FrenchPressCard({this.coffeeDeets}); 

  @override
  _FrenchPressCardState createState() => _FrenchPressCardState();

  final coffeeDeets;
}

class _FrenchPressCardState extends State<FrenchPressCard> {
