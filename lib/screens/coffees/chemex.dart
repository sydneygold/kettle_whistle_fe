...
class ChemexCard extends StatefulWidget {
  ChemexCard({this.coffeeDeets}); 

  @override
  _ChemexCardState createState() => _ChemexCardState();

  final coffeeDeets;
}

class _ChemexCardState extends State<ChemexCard> {
  String name;
  String image;
  String ingredients;
  String tools;
